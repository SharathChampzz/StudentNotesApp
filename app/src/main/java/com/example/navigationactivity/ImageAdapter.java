...
public class ImageAdapter extends RecyclerView.Adapter<ImageAdapter.ImageViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ImageViewHolder holder, int position) {
        ...
        String name;
        try{
            name = "Uploaded By : " + uploadCurrent.getUploaderName();
        }
        catch (Exception e){
    ...
    , MenuItem.OnMenuItemClickListener {
        public TextView textViewName, uploaderName;
        ...
        public void onCreateContextMenu(ContextMenu contextMenu, View view, ContextMenu.ContextMenuInfo contextMenuInfo) {
            ...
            MenuItem downloadd = contextMenu.add(Menu.NONE, 1, 1, "Download");
            MenuItem delete = contextMenu.add(Menu.NONE, 2, 2, "Delete");
            //MenuItem download = contextMenu.add(Menu.NONE, 3, 3, "Delete");

            downloadd.setOnMenuItemClickListener(this);
