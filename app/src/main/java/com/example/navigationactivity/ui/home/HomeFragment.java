...
//import com.example.navigationactivity.ProfileManagement;
...
public class HomeFragment extends Fragment implements AdapterView.OnItemSelectedListener {
    ...
    // Uploading Activity
    private String UploaderEmailId;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        UploaderEmailId = storeData.getEmailId();
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        uploderNamee = view.findViewById(R.id.uploaderNam);
            ...
            public void onClick(View v) {
                ...
                if (mUploadTask != null && mUploadTask.isInProgress()) {
                    ...
                    if (acct != null) {
                        ...
                        Toast.makeText(mFrgAct, personEmail, Toast.LENGTH_SHORT).show();
                    }
                    concat =  "uploads/" + clgName + '/' + branchName + '/' + semester ;
                    Toast.makeText(getContext(), concat, Toast.LENGTH_SHORT).show();
                    mStorageRef = FirebaseStorage.getInstance().getReference(concat);
                    mDatabaseRef = FirebaseDatabase.getInstance().getReference(concat);
                    UploaderEmailId = storeData.getEmailId();
                    //user = "user/" + UploaderEmailId;
                    //profDatabaseref = FirebaseDatabase.getInstance().getReference(user);
                    if(clgName.equals("") || branchName.equals("") || semester.equals("")){
                        Toast.makeText(mFrgAct, "Please Select all Sections", Toast.LENGTH_SHORT).show();
                    }
                    else{
                        uploadFile();
                    }
                    ...
                    .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            Upload upload = new Upload(mEditTextFileName.getText().toString().trim(),
                                    ...
                                    url.toString() ,
                                    UploaderEmailId,
                                    uploderNamee.getText().toString()
                            );

                            //String fileURl = fileReference.getDownloadUrl().toString();
                            //Toast.makeText(MainActivity.this, fileURl, Toast.LENGTH_SHORT).show();
                            String uploadId = mDatabaseRef.push().getKey();
                            mDatabaseRef.child(uploadId).setValue(upload);
                            //Toast.makeText(getContext(), concat + uploadId, Toast.LENGTH_SHORT).show();
